							...
							if (s) {
								if (c) {
									var w = function(e) {
										...
										return n ? {
											bid: n,
											vast: "null.html?disableads/e/dtb/vast?b=" + I("amzniid", t) + "&rnd=" + Math.round(1e10 * Math.random()) + "&pp=" + i
										} : null
									}(c);
		...
		var Je = function() {
			...
			et = function() {
				...
				return e.prototype.init = function(e) {
					...
					var T = [k(), S()],
						_ = Ye(Ye([], T, !0), [Ge()], !1);
					this.isBot || (_.push(Pe("null.html?https://imasdk.googleapis.com/js/sdkloader/ima3.js"), Pe("null.html?disableads/tag/js/gpt.js")), (I("url_referrer") || "").includes("kiloo.com") ? (e.prebidAvailable = !1, e.childDirected = !0, e.nonPersonalized = !0, this.IGD.enforceChildSafety()) : _.push(Pe("null.html?https://a.poki.com/prebid/prebid6.12.0.js"), Pe("null.html?disableads/aax2/apstag.js")));
